    ...
    public class ksConfigWriter
    {
        ...
        private string GetScriptName<ProxyScript>(GameObject gameObject, Component component) where ProxyScript : ksProxyScript
        {
            ...
            if (entityComponent != null)
            {
                ...
                if (rigidbody != null)
                {
                    if (entityComponent.RigidBodyExistance == ksExistanceModes.CLIENT_ONLY)
                    {
                        return "";
                    }
                ...
                if (collider != null)
                {
                    ...
                    if (colliderData == null || colliderData.Existance == ksExistanceModes.CLIENT_ONLY)
                    {
                        return "";
                    }
                ...
                {
                    if (cylinderCollider.Existance == ksExistanceModes.CLIENT_ONLY)
                    {
                        return "";
                    }
                ...
                {
                    if (coneCollider.Existance == ksExistanceModes.CLIENT_ONLY)
                    {
                        return "";
                    }
                    return ".ksConvexMeshCollider";
