...
namespace KS.Reactor.Client.Unity
{
        ...
        where Script : ksMonoScript<Parent, Script>
    {
        ...
        /// <summary>
        /// Finds <see cref="ksEntityScript"/>s on the entity's game object and adds them to the  script list and calls
        /// their <see cref="ksMonoScript{Parent, Script}.Attached"/> method.
        /// </summary>
