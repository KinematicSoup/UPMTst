...
namespace KS.Reactor.Client.Unity
{
    ...
    public class ksRoomType : MonoBehaviour
    {
        ...
        /// <summary>
        /// Should player controller updates use multithreading to update in parallel? If true and
        /// <see cref="ksPhysicsSettings.AutoSync"/> is true, transform changes will sync with the physics system
        /// before updating player controllers, and <see cref="ksPhysicsSettings.AutoSync"/> will be temporarily
        /// disabled while controllers update.
        /// </summary>
        public bool ParallelControllerUpdates { get { return m_parallelControllerUpdates; } }
        [SerializeField]
        [Tooltip("Should player controller updates use multithreading to update in parallel? If true and " +
            "ksPhysicsSettings.AutoSync is true, transform changes will sync with the physics system before updating " +
            "player controllers, and auto sync will be temporarily disabled while controllers update.")]
